		...
		<footer className="mt-auto text-white bg-brand-text">
			<div className="container px-4 py-12 mx-auto sm:px-6 lg:px-8">
				<div className="grid grid-cols-1 gap-8 md:grid-cols-4">
					{/* Column 1 - Brand */}
					<div>
						<h3 className="mb-2 text-2xl font-bold tracking-wider text-white font-display">
							TRANG ALLURE
						</h3>
						<div className="flex flex-wrap gap-1 text-sm text-white/70">
							<span>6,7K người theo dõi</span>
							<span>·</span>
							<span>4,2K đang theo dõi</span>
						</div>
						<div className="flex flex-wrap gap-1 mt-3 text-sm font-medium text-white/80">
						...
						<p className="mt-1 text-sm text-white/60">Mua sắm &amp; bán lẻ</p>
					</div>

					{/* Column 2 - Quick Links */}
					<div>
						<h4 className="mb-4 font-semibold text-white/90">Liên kết nhanh</h4>
						<ul className="space-y-2 text-sm text-white/70">
							<li>
								<Link to="/" className="transition hover:text-brand-secondary">
									Trang chủ
								</Link>
							</li>
							<li>
					...
					<div>
						...
						<div className="flex flex-wrap gap-3">
							{/* Facebook */}
							<a
								href="https://www.facebook.com/thuy.trang.nguyen.501282"
								target="_blank"
								rel="noopener noreferrer"
								className="p-3 transition duration-200 rounded-full bg-white/10 hover:bg-white/20 hover:scale-110"
								aria-label="Facebook"
							>
							...
							{/* Messenger */}
							<a
								href="https://m.me/thuy.trang.nguyen.501282"
								target="_blank"
								rel="noopener noreferrer"
								className="p-3 transition duration-200 rounded-full bg-white/10 hover:bg-white/20 hover:scale-110"
