...
const ProductCard = memo(({ product }) => {
  return (
    <Link to={`/san-pham/${product.slug}`}>
      <div className="overflow-hidden transition bg-white border border-gray-200 rounded-xl hover:shadow-md hover:border-brand-primary/30 dark:bg-gray-800 dark:border-gray-700">
