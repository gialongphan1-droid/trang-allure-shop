...
const BANNER_DRAFT_KEY = "bannerFormDraft";
...
const AdminBanners = () => {
  ...
  const [formData, setFormData, clearDraft] = useDraft(BANNER_DRAFT_KEY, {
    title: "",
    image: "",
    link: "",
    position: 0,
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-wrap items-center gap-4">
        ...
        {search && (
          <div className="text-sm text-muted-foreground">Kết quả: {filteredBanners.length} banner</div>
        )}
      </div>
              ...
              {loading ? (
                ...
                <TableRow>
                  <TableCell colSpan={7} className="py-12 text-center text-muted-foreground">
                    {search ? "Không tìm thấy banner nào phù hợp" : "Chưa có banner nào"}
                  </TableCell>
                </TableRow>
              ) : (
                filteredBanners.map((banner, index) => (
                  <TableRow key={banner._id} className="hover:bg-brand-primary/5 transition-colors">
                    ...
                    <TableCell>
                      <Badge
                        className={
                          banner.isActive ? "bg-green-500 hover:bg-green-600" : "bg-destructive hover:bg-destructive/90"
                        }
                      >
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              ...
              <span className="font-medium text-foreground">{deleteTarget?.title || "không tên"}</span>"? Hành động này
              không thể hoàn tác.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
