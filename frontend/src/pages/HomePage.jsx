...
const HomePage = () => {
  ...
  const goToBanner = useCallback((index) => {
    if (isTransitioning || index === currentBannerIndex || banners.length <= 1) return;
    ...
    <>
      ...
      <div className="space-y-12">
        ...
        {!bannerLoading && banners.length > 0 ? (
          ...
          !bannerLoading && <div className="h-56 bg-gray-200 sm:h-72 md:h-96 dark:bg-gray-700 rounded-2xl animate-pulse"></div>
        )}
